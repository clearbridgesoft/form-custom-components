...
var DateTime = function (_React$Component) {
  ...
  function DateTime(props) {
    ...
    _this.state = {
      datetime: defaultValue || (0, _moment2.default)().format(_this.props.format)
    };

    _this.onChange = function (dateObject) {
      var datetime = dateObject.format(_this.props.format);
      _this.setState({ datetime: datetime });
      onChange(datetime);
    };

    _this.onChange.bind(_this);
    return _this;
  }
